...
const SignIn = () => {
    const [email, setEmail] = useState(process.env.NODE_ENV === 'development' ? "imranbappy.official@gmail.com" : "");
    const [password, setPassword] = useState(process.env.NODE_ENV === 'development' ? "pass123" : "");
